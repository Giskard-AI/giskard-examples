**🚧 Please note that the conversion of notebooks to v2 is work-in-progress! The converted ones are in the directory [notebooks](https://github.com/Giskard-AI/giskard-examples/tree/feature/new-upload-api/notebooks) 🚧**
